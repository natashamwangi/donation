...
class SearchViewCompatHoneycomb {
    ...
    static class C00341 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C00341(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C00352 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C00352(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
