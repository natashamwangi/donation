    ...
    private void parallaxOtherViews(float slideOffset) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (v != this.mSlideableView) {
                ...
                v.offsetLeftAndRight(oldOffset - ((int) ((DefaultRetryPolicy.DEFAULT_BACKOFF_MULT - slideOffset) * ((float) this.mParallaxBy))));
                if (dimViews) {
                    dimChildView(v, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT - this.mParallaxOffset, this.mCoveredFadeColor);
                }
            }
        }
    }
