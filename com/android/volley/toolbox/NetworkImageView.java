...
public class NetworkImageView extends ImageView {
    ...
    class C01021 implements ImageListener {
        ...
        class C00461 implements Runnable {
            ...
            C00461(ImageContainer imageContainer) {
                this.val$response = imageContainer;
            }

            public void run() {
                C01021.this.onResponse(this.val$response, false);
            }
        }
        ...
        public void onResponse(ImageContainer response, boolean isImmediate) {
            if (isImmediate && this.val$isInLayoutPass) {
                NetworkImageView.this.post(new C00461(response));
    ...
    void loadImageIfNecessary(boolean isInLayoutPass) {
        ...
        if (width != 0 || height != 0 || isFullyWrapContent) {
            ...
            this.mImageContainer = this.mImageLoader.get(this.mUrl, new C01021(isInLayoutPass), maxWidth, maxHeight);
        }
    }
